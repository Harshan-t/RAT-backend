...
const jwtDemoController = require('../controller/jwtDemo');

// JWT Demo Routes (isolated; does not impact existing project routes)
router.post('/jwt-demo/login', jwtDemoController.issueToken);
router.get('/jwt-demo/verify', jwtDemoController.verifyToken);
